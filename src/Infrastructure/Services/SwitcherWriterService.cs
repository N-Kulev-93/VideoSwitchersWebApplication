...
{
    internal class SwitcherWriterService : ISwitcherWriterService, IDisposable
    {
        readonly SwitchersWriteContext _dbContext;

        VideoSwitcher? _currentTarget;

        public SwitcherWriterService(SwitchersWriteContext dbContext)
        {
