...
namespace Infrastructure.Services
{
    ...
    internal class SwitcherActionWriterUnitOfWork : ISwitcherActionUnitOfWork, IDisposable
    {
        ...
        public SwitcherActionWriterUnitOfWork(ISwitcherWriterService writer, IClientConnectionProviderService connectionProvider)
        {
            _writer = writer;
        ...
        public void WriteAction(VideoSwitcher videoSwitcher, ActionType action)
        {
            ...
            var command = SwitcherActionCommandFormatter.FormatActionCommand(videoSwitcher, action);
